...
// Auto-generated page for: Federated anomaly detection trained on aggregate data withou

export default function CfFederatedAnomalyDetectionTrainedOnA() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-federated-anomaly-detection-trained-on-a', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Federated anomaly detection trained on aggregate data withou</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Federated anomaly detection trained on aggregate data without raw telemetry leaving the plant.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Federated anomaly detection trained on aggregate data withou'}
        </button>
      </form>
