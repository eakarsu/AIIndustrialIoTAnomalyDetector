...
// Auto-generated page for: No predict-failure endpoint

export default function GapNoPredictFailureEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-predict-failure-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No predict-failure endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No predict-failure endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No predict-failure endpoint'}
        </button>
      </form>
