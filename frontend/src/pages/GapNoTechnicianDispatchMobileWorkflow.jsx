...
// Auto-generated page for: No technician dispatch / mobile workflow

export default function GapNoTechnicianDispatchMobileWorkflow() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-technician-dispatch-mobile-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No technician dispatch / mobile workflow</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No technician dispatch / mobile workflow</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No technician dispatch / mobile workflow'}
        </button>
      </form>
