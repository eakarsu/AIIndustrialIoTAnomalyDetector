...
// Auto-generated page for: Vibration + acoustic monitoring for early bearing/motor fail

export default function CfVibrationAcousticMonitoringForEarly() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vibration-acoustic-monitoring-for-early-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Vibration + acoustic monitoring for early bearing/motor fail</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Vibration + acoustic monitoring for early bearing/motor failure detection.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Vibration + acoustic monitoring for early bearing/motor fail'}
        </button>
      </form>
