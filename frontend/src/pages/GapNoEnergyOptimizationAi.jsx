...
// Auto-generated page for: No energy-optimization AI

export default function GapNoEnergyOptimizationAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-energy-optimization-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No energy-optimization AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No energy-optimization AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No energy-optimization AI'}
        </button>
      </form>
