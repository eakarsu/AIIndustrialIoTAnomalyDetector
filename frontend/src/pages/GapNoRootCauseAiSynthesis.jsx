...
// Auto-generated page for: No root-cause AI synthesis

export default function GapNoRootCauseAiSynthesis() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-root-cause-ai-synthesis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No root-cause AI synthesis</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No root-cause AI synthesis</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No root-cause AI synthesis'}
        </button>
      </form>
