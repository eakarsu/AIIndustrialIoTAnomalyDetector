...
// Auto-generated page for: No /detect-anomaly endpoint with ML model

export default function GapNoDetectAnomalyEndpointWithMl() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-detect-anomaly-endpoint-with-ml', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No /detect-anomaly endpoint with ML model</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No /detect-anomaly endpoint with ML model</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No /detect-anomaly endpoint with ML model'}
        </button>
      </form>
