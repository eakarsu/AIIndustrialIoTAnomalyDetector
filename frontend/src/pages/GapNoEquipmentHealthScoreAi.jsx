...
// Auto-generated page for: No equipment health-score AI

export default function GapNoEquipmentHealthScoreAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-equipment-health-score-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No equipment health-score AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No equipment health-score AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No equipment health-score AI'}
        </button>
      </form>
