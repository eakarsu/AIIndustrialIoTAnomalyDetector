...
// Auto-generated page for: Energy efficiency optimizer recommending operational changes

export default function CfEnergyEfficiencyOptimizerRecommending() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-energy-efficiency-optimizer-recommending', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Energy efficiency optimizer recommending operational changes</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Energy efficiency optimizer recommending operational changes and maintenance timing.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Energy efficiency optimizer recommending operational changes'}
        </button>
      </form>
