...
// Auto-generated page for: No maintenance-recommendation AI

export default function GapNoMaintenanceRecommendationAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-maintenance-recommendation-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No maintenance-recommendation AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No maintenance-recommendation AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No maintenance-recommendation AI'}
        </button>
      </form>
